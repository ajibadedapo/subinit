    ...
    <section id="feed_stream">
        <div class="PostsContainer recent_posts js-widget" >
            <div class="post box" style="">
                @if(Route::is('profile'))
                <i class="edit_post pull-right DropdownMenu js-widget">
                ...
                <div class="message Emoji">
                    <audio style="width: 100%; height: 100%;" id="player2" src="{{url('audiocontent/'.$contents->audio)}}" type="audio/mp3" controls="controls">
                    </audio>
                </div>
